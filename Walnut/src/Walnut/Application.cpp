...
namespace Walnut {
	...
	void Application::SetDefaultLayout(ImGuiID& dockspace_id, ImGuiDockNodeFlags& dockspace_flags)
	{
		...
		ImGuiID dock_id_topleft = ImGui::DockBuilderSplitNode(dock_main_id, ImGuiDir_Left, 0.4f, NULL, &dock_main_id);
	...
	void Application::SetupImGuiStyle()
	{
		...
		colors[ImGuiCol_TitleBg] = ImVec4(0.157f, 0.032f, 0.158f, 0.689f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.157f, 0.032f, 0.158f, 1.00f);
		...
		colors[ImGuiCol_Button] = ImVec4(0.397f, 0.114f, 0.386f, 0.5f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.218f, 0.007f, 0.321f, 0.784f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.397f, 0.114f, 0.386f, 1.0f);
		colors[ImGuiCol_Header] = ImVec4(0.295f, 0.154f, 0.287f, 0.621);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.295f, 0.154f, 0.287f, 0.36f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.218f, 0.007f, 0.321f, 0.784f);
		...
		colors[ImGuiCol_TextSelectedBg] = ImVec4(0.218f, 0.007f, 0.321f, 0.784f);
